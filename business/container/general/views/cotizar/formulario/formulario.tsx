...
function Formulario(props: any) {
  ...
  const [productContact, setProductContact] = useState({ id: "CC" });
      ...
      <div className={styles.formulario}>
        ...
        <form>
          ...
          {hiddenBtn ?
            ...
            :
            <a href={link_to_wsp} target="_blank" type="submit" onClick={deleteCookie} >
