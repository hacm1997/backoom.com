        ...
        <div className={styles.general}>
          ...
          <div className={styles.content_3}>
            ...
            <div className={styles.social}>
              <a href={footer.socialMedia.urls.instagram.url} target="_blank">
                {" "}
                <i
              ...
              <a href={footer.socialMedia.urls.facebook.url} target="_blank">
                <i
                  className="bx bxl-facebook"
                  title={footer.socialMedia.urls.facebook.title}
                ></i>
              </a>
              <a href={footer.socialMedia.urls.linkedin.url} target="_blank">
                {" "}
                <i
            ...
            <div className={styles.policy}>
              <a href="/Terminos y condiciones - Backoom.pdf" target="_blank">
